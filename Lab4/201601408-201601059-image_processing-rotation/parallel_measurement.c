...
static PPMImage *change_image_rotation(PPMImage *image){
    //printf("hello\n");
	...
	for(j=0;j<height;j++){
            ...
            if(changed_i<0 || changed_i>width) continue;
            if(changed_j<0 || changed_j>height) continue;
		//printf("%d %d %d %d\n",i,j,changed_i,changed_j);
...
int main(int argc, char* argv[]) {
    ...
    PPMImage* x = change_image_rotation(image);
    //-----------------------------------------------------------------------------------------
    ...
    strcat(outputfilename, "_rotated");
